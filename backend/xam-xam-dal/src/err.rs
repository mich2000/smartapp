    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            XamXamError::EmailAndPasswordIsEmpty => {
                write!(f, "Email and password can't be equal to nothing")
            }
            ...
            XamXamError::PasswordAndPasswordConfirmedNotEqual => {
                write!(f, "Password and confirmed password aren't the same")
            }
            ...
            XamXamError::UserDeleteFailed => write!(
                f,
                "The user's password wasn't correct or delete confirmation was not set to true"
            ),
