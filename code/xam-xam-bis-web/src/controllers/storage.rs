...
use crate::PgPool;
use actix_web::{get, post, put, delete, web::Data, web::Json, HttpResponse};
...
#[put("/storage")]
pub async fn edit_storage(id : UserId, pg : Data<PgPool>, model : Json<EditStorage>) -> Result<HttpResponse,XamXamWebError> {
